...
function SalesFunnelPage() {
  ...
  return (
    <div className="bg-slate-950 min-h-screen pt-32 pb-24 font-sans text-slate-50 relative overflow-hidden">
      <Helmet>
        <title>Planes y Precios - DIGITRIAL</title>
        <meta name="description" content="Elige el plan que hará crecer tu negocio en línea. Soluciones digitales a medida para tu empresa." />
      </Helmet>

      
      {/* Promo Banner */}
      <div className="bg-gradient-to-r from-emerald-500/20 to-blue-500/20 border-b border-emerald-500/30 py-2 text-center relative z-20">
